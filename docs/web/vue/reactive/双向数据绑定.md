...
tag:
    ...
    - 双休数据绑定
category: vue
prev: /web/vue/diff/虚拟DOM与diff算法
next: /web/vue/ast/抽象语法树
---
...
[代码地址](https://gitee.com/bestshi/blog/tree/master/src/vue/reactive)
...
<img :src="$withBase('/images/数据响应式.jpg')">
...
<img :src="$withBase('/images/bestshi.com_2021-03-24_18-13-41.png')">

<img :src="$withBase('/images/bestshi.com_2021-03-24_18-14-35.png')">
